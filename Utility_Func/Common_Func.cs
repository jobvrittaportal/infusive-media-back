namespace Infusive_back.Utility_Func
{
    ...
    {
        private readonly static string Env = "STAGE"; // STAGE, LIVE      decrypt_talent_stg, infusive_stage
        public static string ConnectionString()
        {
            if (Env == "STAGE")
                return "Server=103.38.50.46;Port=3306;Database=infusive_stage;User=jungle_avengers;Password=Tek123!@#;";
            else if (Env == "LIVE")
